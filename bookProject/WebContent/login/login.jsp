...
window.onload = function(){
 document.getElementById("btnHome").addEventListener("click", goReg, false);
};
</script>
    ...
    <div id="contents" class="fadein">
      ...
      <div class="content">
        ...
        <div class="content-wrapper">
          ...
          <span class="service-msg">로 그 인</span>
          <!-- form -->
          <div class="container">
           <div class="row">
           <!-- check 를 통해 입력자료를 검사하는데 여기서 true를 받아야 submit이 된다. -->
            <form action="loginproc.jsp" name="loginFrm" onsubmit="return loginCheck()">
        		...
        		<button class="btn waves-effect waves-light N/A transparent z-depth-3" type="submit" name="action">로그인
   				 <i class="material-icons right">send</i>
  				</button><br><br>
  				<span class="service-msg">
  				아직도 계정이 없으신가요? &nbsp;&nbsp;<a href="register.jsp"><b style="color: red;">회원가입!</b></a>
  				</span>
